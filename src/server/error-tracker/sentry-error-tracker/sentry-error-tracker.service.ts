...
import { SentryConfig, ServerConfig } from 'src/server/configuration/interfaces';
import { ConfigIdentifier } from '../../configuration/constants';
import { ErrorTrackerService } from '../error-tracker-service.interface';

@Injectable()
export class SentryErrorTrackerService implements ErrorTrackerService {
  constructor(
